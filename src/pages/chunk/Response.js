export default {
  ...
  searchInformation: {
    ...
    totalResults: "595000000",
    formattedTotalResults: "595,000,000",
  },
  items: [
    {
    ...
    },
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcReHoAQZmpY3t9Xvt9endQDtvZHF_nx-Qlaf_xKqd59_H2h32eRtbAjIZYq",
            width: "330",
            height: "153",
          },
        ],
        metatags: [
          {
            "msapplication-tilecolor": "#cc0000",
            "og:image":
              "https://www.tesla.com/ns_videos/commerce/content/dam/tesla/tesla-shop-marketing-imagery/hero-carousel/wall-connector.jpg",
            "og:type": "website",
            "twitter:card": "summary_large_image",
